...
# def calculate_bleu_scores(decoded_labels, decoded_preds, max_order):
...
#     result = bleu.compute(predictions=predictions, references=references, max_order=max_order, smooth=False)
#     return result["bleu"]

# def calculate_rouge_scores(decoded_labels, decoded_preds, type='rouge1'):
#     scores = []
#     rouge = load_metric("rouge",trust_remote_code=True)
#     for reference, prediction in zip(decoded_labels, decoded_preds):
#         score = rouge.compute(predictions=[prediction], references=[reference])[type].mid.fmeasure
#         scores.append(score)
#     return np.mean(scores)

# def calculate_meteor_scores(decoded_labels, decoded_preds):
#     scores = []
